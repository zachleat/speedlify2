...
export const SCORES = [
	{ key: "performance", path: "lab.scores.performance", label: "Performance", short: "PERF" },
	{ key: "accessibility", path: "lab.scores.accessibility", label: "Accessibility", short: "A11Y" },
	{ key: "best-practices", path: "lab.scores.best-practices", label: "Best Practices", short: "BEST" },
	{ key: "seo", path: "lab.scores.seo", label: "SEO", short: "SEO" },
];
...
/**
 * The site page's single metrics table: lab and field side by side.
 *
 * `lab` and `field` name the row's key in each half, and a null says the metric
 * has no counterpart there at all — Lighthouse cannot measure INP in a lab run,
 * and CrUX reports neither TBT nor Speed Index. That is a different fact from a
 * measurement that is merely missing, and the page says so rather than printing
 * the same dash for both.
 */
export const COMBINED_METRICS = [
	{ key: "lcp", label: "LCP", unit: "ms", note: "Largest Contentful Paint", coreWebVital: true, lab: "lcp", field: "lcp" },
	{ key: "inp", label: "INP", unit: "ms", coreWebVital: true, lab: null, field: "inp",
	  note: "Interaction to Next Paint — field only, no lab run can measure it" },
	{ key: "cls", label: "CLS", unit: "", note: "Cumulative Layout Shift", coreWebVital: true, lab: "cls", field: "cls" },
	{ key: "tbt", label: "TBT", unit: "ms", note: "Total Blocking Time", lab: "tbt", field: null },
	{ key: "fcp", label: "FCP", unit: "ms", note: "First Contentful Paint", lab: "fcp", field: "fcp" },
	{ key: "si", label: "Speed Index", unit: "ms", lab: "si", field: null },
	{ key: "ttfb", label: "TTFB", unit: "ms", note: "Time to First Byte", lab: "ttfb", field: "ttfb" },
];
...
export default { SCORES, LAB_METRICS, FIELD_METRICS, COMBINED_METRICS, WEIGHT_METRICS, HEALTH_METRICS, ALL_TRACKED };
