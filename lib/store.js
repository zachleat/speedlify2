...
export class ResultStore {
	...
	write(record) {
		...
		this.writeScreenshots(dir, {
			...
			noJsColors: pageShots?.noJsColors ?? null,
		});
	 ...
	 */
	writeScreenshots(dir, { primary = null, noJs = null, difference = null, noJsColors = null } = {}) {
		...
		manifest = {
			...
			noJsColors: wroteNoJs ? noJsColors : (noJsColors ?? manifest.noJsColors ?? null),
		};
