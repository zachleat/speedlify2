...
export class ResultStore {
	...
	write(record) {
		...
		this.writeScreenshots(dir, {
			...
			noJsEmpty: pageShots?.noJsEmpty ?? null,
		});
	 ...
	 */
	writeScreenshots(dir, { primary = null, noJs = null, difference = null, noJsEmpty = null } = {}) {
		...
		manifest = {
			...
			noJsEmpty: wroteNoJs ? noJsEmpty : (noJsEmpty ?? manifest.noJsEmpty ?? null),
		};
